...
import id.dgd.hwitatravel.adapter.GridAdapter;
import id.dgd.hwitatravel.adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setPadding(getResources().getDimensionPixelSize(R.dimen.view_pager_padding_left), 0,
                getResources().getDimensionPixelSize(R.dimen.view_pager_padding_right), 0);
